...
export function IssueFilterBar({ issues }: Props) {
  const { statusFilter, priorityFilter, keyword, setStatusFilter, setPriorityFilter, setKeyword } =
    useRedmineStore()
    ...
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="일감 검색"
          className="pl-8 pr-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-44"
        />
      </div>
    </div>
  )
