...
| M8 | 대시보드 카드 상세 패널 + 최근 활동 링크 + 기간 필터 (Sprint 8) | ✅ 완료 |
...
## Sprint 8 — 대시보드 카드 상세 패널 + 최근 활동 링크 + 기간 필터

> **목표**: 대시보드 요약 카드 클릭 시 상세 내역 패널 표시, 최근 활동 원본 링크 추가, 최근 활동 기간 필터 드롭다운 구현
> **상태**: ✅ 완료 (2026-03-15)
> **브랜치**: `sprint8`

### 작업 목록

- ✅ SummaryDetailPanel 신규 생성 — 요약 카드 클릭 시 우측 슬라이드인 패널 (오버레이 + X 버튼 닫기)
- ✅ DashboardPage — 요약 카드 4종 onClick 연결 → 슬라이드인 패널 열기
- ✅ DashboardPage — recentActivity에 url 필드 추가 (커밋: web_url, 이슈: redmineUrl/issues/id)
- ✅ DashboardPage — 최근 활동 기간 드롭다운 추가 (1일/3일/1주일/2주일/1개월/전체, 기본 1주일)
- ✅ DashboardPage — 최근 활동 각 항목에 ExternalLink 아이콘 링크 추가

### 완료 기준

- 요약 카드 클릭 시 해당 타입(담당일감/커밋/진행중/기한초과)의 상세 목록 패널 표시
- 패널 오버레이 클릭 또는 X 버튼으로 닫힘
- 최근 활동 커밋/이슈 항목에 원본 링크 아이콘 표시 (새 탭 열기)
- 기간 드롭다운 선택 변경 시 클라이언트 사이드 필터링 즉시 적용
...
| v0.8 | Sprint 8 완료 — 대시보드 카드 상세 패널 + 최근 활동 링크 + 기간 필터 | 2026-03-15 |
